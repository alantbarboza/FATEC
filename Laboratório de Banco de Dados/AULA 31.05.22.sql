...
--31/05/22
--HAVING: ele é a condição + o agrupamento
--group by: é apenas o agrupamento
...
--listar o total de material por obra, porém apenas as obras com um total menor que 100
...
update material set unidade_mensuração = 'cx'
...
update substitui
set data_substituição = '2019-01-01',
    motivo = 'feriado'
...
--Atualiza o endereço de aluno1 cujo estado é RJ e este possui tarefa associada.
