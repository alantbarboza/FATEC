							...
							<div id="tab1" class="tab-pane fade in active">
								<div class="row">
									<div class="col-md-11">
										...
										<p>Cada nota é reproduzida de forma mais realistica porque a pureza do áudio começa na fonte com seu dispositivo
                                           Samsung Galaxy favorito. O codificador com tecnologia Samsung Seamless Codec atualizado codifica o áudio completo
                                           de 24 bits e é decodificado via Galaxy Buds2 Pro, mantendo o mesmo padrão de som de alta qualidade de 24 bits desde
                                           a origem..</p></br>

                                            <b>Sensores</b></br>
                                            Acelerômetro, sensor giroscópio, sensor de efeito Hall, sensor de proximidade, sensor de toque,</br>
                                            VPU (Voice Pickup Unit [unidade de captação de voz])</br>
	
                                            <b>Número de microfones</b></br>
                                            6 Microfones de Alta Sensibilidade a Ruído (3 Microfones cada fone)</br>

                                            <b>Speaker</b></br>
                                            Alto-falante Coaxial Duplo</br>

                                            <b>Áudio Codec</b></br>
                                            SSC (Samsung Seamless Codec) HiFi, AAC, SBC</br>

                                            <b>Perfis de Bluetooth</b></br>
                                            A2DP, AVRCP, HFP</br>

                                            <b>Tempo de Reprodução de Áudio</b></br>
                                            Até 18 (Fone até 5 horas)</br>
											
											<b>Dimensões do fone de ouvido (AxLxP)</b></br>
                                            21.6 x 19.9 x 18.7 mm</br>
										</p>
									</div>
								</div>
							</div>				
	...
	function detalhes(){
		...
		<article class='produtos-preco'>
			...
			<div>
				...
				<h5>ou até 10x de R$149,90 sem juros <a href='https://parcelamento.com'>ver parcelamento</a></h5>";   
		}
