...
{   int l, c;
    for(l=0; l<linhas; l++)
    {   for(c=0; c<colunas; c++)
        {   original[l][c] = (int)(original[l][c] * 0.80);
        }
    }
}
...
{   int l, c;
    ...
    for(l=1;l<20;l++){
        for(c=0; c< colunas; c++){
            original[l][c] = (int)(original[l][c] * 0.20);
            original[linhas-l][c] = (int)(original[linhas-l][c] * 0.20);
        }
    }
    ...
    for(c=1; c< 20; c++){
        for(l=1;l<linhas;l++){
            original[l][c] = (int)(original[l][c] * 0.20);
            original[l][colunas-c] = (int)(original[l][colunas-c] * 0.20);
        }
    }
