		...
		<div class="container">
			...
			<div class="row">
				...
				<?php  detalhes(); ?>
						...
						<form method='post' 	>
							<button type="submit" class="btn btn-danger col-md-12" name="comprar">Comprar</button></br>
						</form>
					  </div></br>
					<?php 
						if(isset($_POST['comprar'])) adicionar();
					?>
				...
				<div class="col-md-12">
					<div id="product-tab">
						...
						<ul class="tab-nav">
							...
							<li><a data-toggle="tab" href="#tab2">Avaliações (42)</a></li>
						</ul>
						<!-- /product tab nav -->
	...
	<div class="section">
		<div class="container">
			...
			<div class="row">
				...
				<!-- product -->
				<div class="col-md-3 col-xs-12">
					  <img src="img/2.jpg" alt="..." width="212.5" height="200">
					  <div class="caption">
...
<?php 
	function detalhes(){
		...
		while($reg = mysqli_fetch_array($resultado)){
			...
			$valor_produto < 100? $juros = 10: $juros = 2;
		...
		<article class='produtos-preco'>
			...
			<div>
				...
				<h5>ou até ". $juros." x de " . number_format($valor_produto / $juros,2,",",".") ."sem juros <a href='https://parcelamento.com'>ver parcelamento</a></h5>";  
	...
	function adicionar() {
		if($_SESSION['usuario_logado']){
			...
			$codigo_produto = $_GET ['codigo_produto'];
			$conexao = new mysqli("localhost", "root", "", "ID4");
			$sql = "INSERT INTO cesta (codigo_cliente, codigo_produto) VALUES ($id,$codigo_produto)";
